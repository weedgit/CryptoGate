...
M3-02 / M3-03 / M4-05 / M4-32 are published. M4-11 OpenAPI freeze is **v0.3.1**. Remaining: M4-12 load tests (Andrew); second live network waits on a registry row — see `doc/M3-04-Asset-Networks.md`.
