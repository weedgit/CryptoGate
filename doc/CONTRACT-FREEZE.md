...
M3-02 / M3-03 / M4-05 / M4-32 / M4-01 / M4-02 / M4-03 / M4-04 / M4-33 / M4-34 are published. M4-11 OpenAPI freeze is **v0.3.1**. Remaining: M4-12 load tests (Andrew); M4-35 DB schema doc (Kevin + Andrew ERD); IaC when Company A picks cloud; second live network waits on a registry row — see `doc/M3-04-Asset-Networks.md`.
