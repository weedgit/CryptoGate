...
/** C11 — Agent team settings (platform team chrome). */
      ...
      <section className="plat-team__card">
        ...
        {loading ? (
          <PlatformPending
            compact
            title="Loading team"
            copy="Fetching agent org members."
          />
        ) : sortedMembers.length === 0 ? (
          <p className="plat-team__empty">No members returned for this agent org.</p>
        ) : (
              ...
              >
                  ...
                  <div className="plat-team__invite-head-text">
                    ...
                    <p className="plat-team__invite-lede">
                      {inviteCreds
                        ...
                        : "Send a portal invite for Administrator or Viewer on this agent org."}
                    </p>
                  </div>
                  <button
                    type="button"
                ...
                >
                  <label
                    ...
                    htmlFor="agent-team-invite-email"
                  >
                    <span>Email</span>
                    <input
                      id="agent-team-invite-email"
        ...
        ? createPortal(
            ...
            >
              <div
                ...
                role="dialog"
                aria-modal="true"
                aria-labelledby="agent-team-remove-title"
                onClick={(e) => e.stopPropagation()}
              >
                <header className="b3-commission-modal__head">
                  <h3 id="agent-team-remove-title">Remove team member</h3>
                  <button
                    type="button"
                    className="b3-commission-modal__close"
                    aria-label="Close"
