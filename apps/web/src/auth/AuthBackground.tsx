      ...
      >
        <defs>
          ...
          <radialGradient id="auth-bg-halo" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#C4A452" stopOpacity="0.28" />
            <stop offset="100%" stopColor="#C4A452" stopOpacity="0" />
          </radialGradient>

          <radialGradient id="auth-bg-inner" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#C4A452" stopOpacity="0.44" />
            <stop offset="65%" stopColor="#C4A452" stopOpacity="0.06" />
            <stop offset="100%" stopColor="#C4A452" stopOpacity="0" />
          </radialGradient>

          <radialGradient id="auth-bg-pulse" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#F2E090" stopOpacity="1" />
            <stop offset="40%" stopColor="#C4A452" stopOpacity="0.62" />
            <stop offset="100%" stopColor="#C4A452" stopOpacity="0" />
          </radialGradient>

          <radialGradient id="auth-bg-settle" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#C4A452" stopOpacity="0.34" />
            <stop offset="100%" stopColor="#C4A452" stopOpacity="0" />
          </radialGradient>
          ...
          {/* Wordmark: darker gold with stronger top-to-bottom contrast. */}
          <linearGradient
            id="auth-bg-wordmark"
            x1={WORDMARK_X}
          ...
          >
            ...
            <stop offset="40%" stopColor="#B89850" />
          ...
          isSettlement ? (
            <g key={`sn-${i}`}>
              ...
              <circle
                ...
                strokeOpacity="0.7"
              />
              <circle cx={x} cy={y} r={2.2} fill="#C4A452" className="auth-bg-settle" />
              <text
                x={x}
                y={y + 22}
                textAnchor="middle"
            ...
            <g key={`sn-${i}`}>
              <circle cx={x} cy={y} r={7} fill="#C4A452" opacity="0.046" />
              <circle
                cx={x}
                cy={y}
                r={3.2}
                ...
                strokeOpacity="0.55"
              />
              <circle cx={x} cy={y} r={1.2} fill="#C4A452" opacity="0.65" />
            </g>
          ),
        )}
            ...
            return (
              <g key={`bm-${si}-${ri}`}>
                <line
                  ...
                  strokeOpacity="0.55"
                />
                <circle cx={bx} cy={by} r={1.4} fill="#C4A452" opacity="0.45" />
              </g>
            );
          });
        })}
        ...
        {pulses.map(({ i, x, y, opacity }) => (
          <g key={`p-${i}`} opacity={opacity}>
            ...
            <circle cx={x} cy={y} r={1.5} fill="#F8E898" opacity="0.97" />
          </g>
        ))}
        ...
        />
        <circle cx={CX} cy={CY} r={5} fill="#C4A452" className="auth-bg-core" />
        <circle cx={CX} cy={CY} r={1.8} fill="#F8E898" opacity="0.97" />
        ...
        <g opacity="0.62">
          ...
          <circle
            ...
            strokeOpacity="0.52"
          />
          <circle cx={origin.x - 28} cy={CY} r={1} fill="#C4A452" opacity="0.58" />
          <text
            x={origin.x - 28}
            y={CY + 36}
            textAnchor="middle"
